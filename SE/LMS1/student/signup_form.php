	<?php
		...
		$cpassword=$_POST['cpassword'];
			...
			$query=mysql_query("select * from member where member_id='$student_no'")or die(mysql_error());
...
<?php  
mysql_query("insert into member_account values("+$student_no+",'"+$password+"')")or die(mysql_error());
?>
<script type="text/javascript">
